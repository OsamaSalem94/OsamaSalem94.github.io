...
const ProjectContent: React.FC<Props> = (props) => {
  return (
    <div
      className={`${props.projectContentClassName} ${classes.ProjectContent}`}
    >
      <p className={classes.ProjectOverline}>
        {props.projectContentData.overline}
      </p>
      <h3 className={classes.ProjectTitle}>{props.projectContentData.title}</h3>
      <p className={classes.ProjectDescription}>
        {props.projectContentData.description}
      </p>
      <MonoTextList
        data={props.projectContentData.techList}
        className={props.projectTechListClassName}
      />
